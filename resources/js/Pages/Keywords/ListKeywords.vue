                        ...
                        <section class=" p-4 mx-auto">
                            <div class="sm:flex sm:items-center sm:justify-between">
                                ...
                                <div class="flex items-center mt-4 gap-x-3">
                                    ...
                                    <Link :href="route('keywords.create')" class="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg sm:w-auto gap-x-2 hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                                        ...
                                        <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                                ...
                                                <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                                    <tr v-for="listKeyword in listKeywords.data" :key="listKeyword.id">
                                                        ...
                                                        <td class="px-4 py-4 text-sm font-normal text-gray-700 whitespace-nowrap"><a class="px-2 py-1 text-green-500 bg-green-100 rounded dark:bg-gray-800" :href="route('keyword-positions.report', listKeyword.id)">{{ listKeyword.keyword }}</a> </td>
                                                        <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{{ listKeyword.domain.name }}</td>
                                                        <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{{ listKeyword.updated_at }}</td>
